...
on ${\theta}$ indica paràmetres de la xarxa que consisteixen en una matriu de pes ${W = [w_{ij}]}$ i un vector de biax ${b = [b_i]}$. ${w_{ij}}$ és el pes de les connexions sinàptiques entre les neurones i i j.  La probabilitat d'un estat x es defineix com: 
\begin{equation}
...
\end{equation} 
on ${v_i}$, ${h_j}$ denoten neurones les neurones visibles i ocultes respectivament i  ${b_{i}}$ i ${c_{j}}$ els biaxos de les neurones visibles i ocultes respectivament.
\newpage
...
Atès que una RBM és un cas especial de BM, és possible utilitzar el mateix mostreig de Gibbs durant l' aprentatge. Gràcies a la seva estructura restringida, el mostreig de Gibbs es pot utilitzar de manera més eficient ja que les neurones de una capa sabent els valors de l'atra son independents (veure Figura 10). \\\\
\begin{figure}[h!]
\begin{center}
