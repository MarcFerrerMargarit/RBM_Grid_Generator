...
Avaluar models generatius com la màquina que em creat és molt complicat ja que no tenim un resultat estàndard per avaluar el resultat obtingut i no qualsevol persona pot detectar si aquell resultat és bo o dolent. Així doncs la nostra forma d'avaluar els nostres resultats serà utilitzant l'ajuda d'un expert per a valorar els moodboards obtinguts. \\\\
...
\end{figure}
\\\\
Com podem observar tots els moodboards segueixen un esquema similar, les caselles on no hi ha objectes sempre solen ser les mateix. També cal observar que hi ha objectes que no tenen imatges, això pot complicar l'avaluació ja que no sabem com és l'objecte col·locat. En aquest punt vam decidir que suposaríem que l'objecte era correcte ja que en cas de suposar el contrari el moodboard ja seria incorrecte. Una millora de l'algorisme seria evitar els objectes que no tenen imatge.\\\\
...
En aquest cas les imatges corresponen a l'estil de \textit{Popular Modern}, és a dir, popular modern. Així doncs, molts dels objectes que s'han col·locat no segueix aquest estil, aquesta línia de popular modern. La majoria són popular tradicional o tradicionals purament per tant, la col·locació d'aquests no es correcte a dins la imatge. \\\\
...
\item Utilitzar la màquina creada, per tal que donada una configuració fixa d'elements en una graella, generar altres ítems sense modificar la distribució de la graella.
\end{itemize}
