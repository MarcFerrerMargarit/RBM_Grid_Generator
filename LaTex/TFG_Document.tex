...
\\\ Així doncs necessitem aplicar una algorisme capaç d'obtenir un diccionari el qual contingui les cel·les del moodboard i cada una d'elles una llista de ID que són els que ens permetran identificar les característiques. Per tal d'aconseguir aquesta transformació farem servir el següent algorisme:
\begin{algorithm}
