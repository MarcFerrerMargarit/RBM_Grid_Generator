...
Amb la realització d'aquest projecte hem aprés que la realització d'una tasca manual, repetitiva i costosa de temps, com és la generació de moodboards, pot ser reemplaçada per una aplicació i una màquina automàtica tal que la combinació de les dues ens permeti agilitzar la tasca tant com es pugui.\\\\
